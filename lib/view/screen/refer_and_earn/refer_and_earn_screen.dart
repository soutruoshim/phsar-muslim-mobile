...
import 'package:phsar_muslim/view/screen/refer_and_earn/widgets/refer_hint_view.dart';
                  ...
                  children: [
                    ...
                    SingleChildScrollView(
                      ...
                      children: shareItem.map((item) => GestureDetector(
                        onTap: () => Share.share('Greetings, PhsarMuslim is the best e-commerce platform in the country. If you are new to this website don’t forget to use "${Provider.of<ProfileProvider>(context, listen: false).userInfoModel?.referCode??''}" as the referral code while sign up into PhsarMuslim. ${'${Provider.of<SplashProvider>(context, listen: false).configModel?.refSignup}${Provider.of<ProfileProvider>(context, listen: false).userInfoModel?.referCode??''}'}',),
